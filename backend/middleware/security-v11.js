/**
 * Advanced Security Middleware - v11.0 FINAL
 * ✅ FIXED: Allow external APIs in connectSrc
 * ✅ FIXED: Configurable CSP for future integrations
 */
...
export const helmetConfig = helmet({
    contentSecurityPolicy: {
        directives: {
            ...
            // ✅ FIXED: Allow external APIs and integrations
            connectSrc: [
                "'self'",
