/**
 * Advanced Security Middleware - v9.0 FINAL
 * 🔥 FIXES: Proper initialization order, length check in CSRF, modern Redis config
 */
 ...
 * This ensures accountLockManager has access to the connected Redis client
 */
export const initAccountLockManager = () => {
    // ✅ FIXED: Create manager AFTER Redis initialization
...
/**
 * Get the account lock manager instance
 */
 ...
 * NOW includes length check before timing-safe comparison
 */
export const csrfProtection = (req, res, next) => {
    ...
    // ✅ FIXED: Check length first before timing-safe comparison
    ...
    try {
        ...
        // But we already checked length above, so this shouldn't happen
...
export const accountLockMiddleware = async (req, res, next) => {
    ...
    try {
        ...
        // Continue anyway - don't block login on error
    }
